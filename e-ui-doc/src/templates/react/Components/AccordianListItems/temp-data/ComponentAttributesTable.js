...
export const ComponentAttributesTable = {
    ...
    {
        "attributeName": (<div>highlightColor <Badge type="success" label="Mandatory" size="11" /></div>),
        "description": "",
        "example": (<div align="center"><b>-</b></div>)
    },
    {
        "attributeName": (<div>defaultColor <Badge type="success" label="Mandatory" size="11" /></div>),
        "description": "",
        "example": (<div align="center"><b>-</b></div>)
    },
    {
        "attributeName": (<div>selectKey <Badge type="success" label="Mandatory" size="11" /></div>),
        "description": "",
        "example": (<div align="center"><b>-</b></div>)
    },
    {
        "attributeName": (<div>selectValue <Badge type="success" label="Mandatory" size="11" /></div>),
        "description": "",
        "example": (<div align="center"><b>-</b></div>)
    }]
};